---
title: multiRL
description: "This package is designed to help users build Rescorla–Wagner models for <b>multi</b>-armed bandit–like tasks. It modularizes the Markov Decision Process (MDP) into <b>six</b> core components, allowing users to flexibly construct models using simple <code>if-else</code> logic."
...
<div class="badges" style="text-decoration: none;">
  ...
  </a><a href="https://app.codecov.io/gh/yuki-961004/multiRL">
    <img src="https://codecov.io/gh/yuki-961004/multiRL/graph/badge.svg" alt="Code Coverage">
  </a><a href="https://CRAN.R-project.org/package=multiRL">
